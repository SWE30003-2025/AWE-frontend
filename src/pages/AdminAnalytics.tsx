...
export default function AdminAnalytics() {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white rounded shadow p-6 mt-8">
      ...
      <div className="mb-2">Total Sales: <span className="font-semibold">${stats.total_sales.toFixed(2)}</span></div>
      <div className="mb-2">Total Orders: <span className="font-semibold">{stats.total_orders}</span></div>
      <div className="mb-2">
